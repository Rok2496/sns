...
export default function CreateSubProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Error creating sub-product');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Create Sub Product</h1>
          <p className="text-gray-600">Add a new sub-product to your catalog</p>
        </div>
      </div>
